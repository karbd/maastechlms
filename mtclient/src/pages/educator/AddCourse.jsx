...
const handleLecture = (action, chapterId, chapterIndex) => {
  if(action === 'add') {
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
          ...
          <div className='flex items-center justify-between flex-wrap'>
            <div className='flex flex-col gap-1'>
              ...
              type='number' placeholder='0' className='outline-none md:py-2.5 py-2 px-3 
              w-28 rounded border border-gray-500' required />
            </div>
          ...
          <div className='flex flex-col gap-1'>
            ...
            placeholder='0' min={0} max={100} className='outline-none md:py-2.5 py-2 px-3 
              w-28 rounded border border-gray-500' required  />
          </div>
          ...
          <div>
            ...
            <div className='flex justify-center items-center bg-blue-100 p-2 rounded-lg curson-poin' 
